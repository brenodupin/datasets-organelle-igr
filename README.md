...
│   ├── supplemental_figures.ipynb  # Jupyter notebook with analysis needed for Supplemental Figures
│   ├── supplemental_table.ipynb    # Jupyter notebook with analysis needed for Supplemental Table
│   └── supplemental_table.tsv.     # Supplemental Table generated by supplemental_table.ipynb
│
├── scripts/                        # Processing scripts
│   ├── brms_2bin.R                 # R code for Bayesian analysis of intergenic region data (2-bin model)
│   ├── brms_3bin.R                 # R code for Bayesian analysis of intergenic region data (3-bin model)
...
The `code/` directory contains Jupyter notebooks for generating Figure 1, 2 and Supplemental materials.
